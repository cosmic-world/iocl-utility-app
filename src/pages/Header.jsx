  ...
  const manuals = [
    {
      ...
      href: `${process.env.PUBLIC_URL}/asset/manuals/TT-Crew-Temporary-Pass-User_Manual.pdf`,
      filename: "TT-Crew-Temporary-Pass-User_Manual.pdf",
    },
    {
      label: "Permit Dashboard Manual",
      href: `${process.env.PUBLIC_URL}/asset/manuals/Permit-Dashboard-User_Manual.pdf`,
      filename: "Permit-Dashboard-User_Manual.pdf",
    },
    {
      label: "Worker Entry Manual",
      href: `${process.env.PUBLIC_URL}/asset/manuals/Worker-Entry-User_Manual.pdf`,
